...
public class SolrQueryHTTPClient implements BeanFactoryAware {
    ...
    /**
     * @param maximumResultsFromUnlimitedQuery the maximum number of results to request from an otherwise unlimited query
     */
    ...
    //TODO
    public String buildQueryBaseUrl(StoreRef storeRef) {
        SolrStoreMapping mapping = extractMapping(storeRef);
    ...
    public HttpClient getClient(StoreRef storeRef) {
        return httpClients.get(storeRef);
    }
    //TODO END
