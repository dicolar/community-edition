...
public class ImporterComponent implements ImporterService {
	...
	private class NodeImporter
		...
		QName PROP_TIMESTAMP = QName.createQName(NamespaceService.SYSTEM_MODEL_1_0_URI, "timestamp");
		/**
		 * Bind properties
		 *
		 * @param properties
		...
		private Map<QName, Serializable> bindProperties(ImportNode context) {
			...
			//TODO add default timestamp!
			boundProperties.put(PROP_TIMESTAMP, System.currentTimeMillis());
